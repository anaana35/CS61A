    ...
    def say(score0, score1):
        ...
        if change > previous_high:
            if change > 1:
                ...
                s = "point!"
            print(change, s, "That's the biggest gain yet for Player", who)
...
def bacon_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 10
    return 0 if margin <= free_bacon(opponent_score) else num_rolls  # Replace this statement
    # END PROBLEM 10
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(score + temp, opponent_score) and opponent_score >= score + temp:
        flag = True
    elif margin <= temp:
        flag = True

    return 0 if flag else num_rolls
